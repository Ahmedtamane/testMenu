...
{
    // Draw different backgrounds based on current state
    if (currentState == MAIN_MENU)
    {
        // Draw only the first background for main menu
    ...
    {
        // Draw the both backgrounds for options menu
        window.draw(backgroundMain);
        window.draw(backgroundOptions);

        // Draw options menu elements
    ...
    {
        // Draw BOTH backgrounds for level select
        window.draw(backgroundMain);
        window.draw(backgroundOptions);

        // Draw level select elements
        window.draw(levelTitle);

        for (int i = 0; i < 3; i++)
        {
            window.draw(levelBoxes[i]);      // Draw the square box
            window.draw(levelSprites[i]);    // Draw the image inside
            window.draw(levelTexts[i]);      // Draw the text under
        }
